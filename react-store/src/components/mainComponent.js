              ...
              <div class="slider-btn">
                <span class="prev position-top">
                  {/* <i class="fas fa-chevron-left fa-2x text-secondary"></i> */}
                    <FontAwesomeIcon
                      className="fas fa-chevron-left fa-2x text-secondary"
                      icon={faChevronLeft}
                    />
                </span>
                <span class="next position-top right-0">
                  {/* <i class="fas fa-chevron-right fa-2x text-secondary"></i> */}
                    <FontAwesomeIcon
                      className="fas fa-chevron-right fa-2x text-secondary"
                      icon={faChevronRight}
                    />
                </span>
              </div>
            ...
            <div class="site-slider-three px-md-4">
              <div class="slider-three row text-center px-4">
                <div class="col-md-2 product pt-md-5">
                  ...
                  <div class="cart-details">
                    ...
                    <div class="rating">
                      ...
                      <FontAwesomeIcon className="fas fa-star" icon={faStar} />
                      {/* <i class="fas fa-star"></i> */}
                      <FontAwesomeIcon className="fas fa-star" icon={faStar} />
                      {/* <i class="fas fa-star"></i> */}
                      <FontAwesomeIcon className="fas fa-star" icon={faStar} />
                      ...
                      <FontAwesomeIcon className="fas fa-star-half-alt" icon={faStarHalfAlt} />
                    </div>
                    ...
                    <div class="cart mt-4">
                      <button class="border site-btn btn-span" type="button" name="button">Add to Cart</button>
                    </div>
                  </div>
                </div>
                <div class="col-md-2 product pt-md-5">
                ...
                <div class="col-md-2 product pt-md-5">
                  ...
                  <div class="cart-details">
                    <h6 class="pro-title p-0">Himalayan Salt Lamp</h6>
                    <div class="rating">
                      {/* <i class="fas fa-star"></i>
                      <i class="fas fa-star"></i>
                      <i class="fas fa-star"></i>
                ...
                <div class="col-md-2 product pt-md-5">
                  ...
                  <div class="cart-details">
                    <h6 class="pro-title p-0">Table Lamp Bedside Desk</h6>
                    <div class="rating">
                      {/* <i class="fas fa-star"></i>
                      <i class="fas fa-star"></i>
                      <i class="fas fa-star"></i>
                ...
                <div class="col-md-2 product pt-md-5">
                  ...
                  <div class="cart-details">
                    <h6 class="pro-title p-0">Persons Modern Ends</h6>
                    <div class="rating">
                      {/* <i class="fas fa-star"></i>
                      <i class="fas fa-star"></i>
                      <i class="fas fa-star"></i>
              ...
              <div class="slider-btn">
                ...
                <span class="next position-top right-0">
                  {/* <i class="fas fa-chevron-right fa-2x text-secondary"></i> */}
                    <FontAwesomeIcon
                      className="as fa-chevron-right fa-2x text-secondary"
                      icon={faChevronRight}
                    />
                </span>
              </div>
            ...
            <div className="row">
                ...
                <div className="row box">
                  <div className="col-md-2 p-0 pl-md-3 bg-white offset-1 d-flex flex-md-column flex-sm-row">
                    <div className="py-md-2 py-2 mt-3 bg-white border text-center">
                      <h5 className="primary-color"><strong>125</strong></h5>
                      <em>Days</em>
                    </div>
                    <div className="py-md-2 py-2 mt-3 bg-white border text-center">
                      <h5 className="primary-color"><strong>5</strong></h5>
                      <em>Hours</em>
                    </div>
                    <div className="py-md-2 py-2 mt-3 bg-white border text-center">
                      <h5 className="primary-color"><strong>45</strong></h5>
                      <em>Mins</em>
                    </div>
                    <div className="py-md-2 py-2 mt-3 bg-white border text-center">
                      <h5 className="primary-color"><strong>13</strong></h5>
                      <em>Secs</em>
                    </div>
                  </div>
              ...
              <div className="col-md-6 col-12 pt-5">
                ...
                <p className="text-secondary">
                  <small>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Congue nisi vitae suscipit tellus mauris a. Semper viverra nam libero justo laoreet sit.
                  </small>
                </p>
                ...
                <h4 className="pt-2">
                  <small><s className="text-secondary">$519.99</s></small>
                  <span className="text-color">$499.00</span>
                </h4>
                <div className="cart mt-4 row">
                  <div className="col-md-4 col-sm-12 p-0">
                    <button className="border site-btn btn-span bg-primary-color text-white">Add to Cart</button>
                  </div>
                  <div className="col-md-5 col-sm-12 p-0 mt-3">
                    ...
                    <span className="p-3 bg-white border rounded-circle">
                      ...
                      <FontAwesomeIcon className="fas fa-sync-alt" icon={faSyncAlt} />
                    </span>
                    <span className="p-3 bg-white border rounded-circle">
                    ...
                    <div className="col-md-9 p-0 py-4 py-md-0">
                      <div className="px-4">
                        ...
                        <div className="rating pb-2">
                          ...
                          <FontAwesomeIcon className="fas fa-star-half-alt" icon={faStar} /> */}
                        </div>
                        <h5>
                          <small><s className="text-secondary">$125.99</s></small>
                  ...
                  <div className="row py-3">
                    ...
                    <div className="col-md-9 p-0 py-4 py-md-0">
                      <div className="px-4">
                        ...
                        <h5>
                          <small><s className="text-secondary">$159.99</s></small>
                  ...
                  <div className="row py-3">
                    ...
                    <div className="col-md-9 p-0 py-4 py-md-0">
                      <div className="px-4">
                        ...
                        <h5>
                          <small><s className="text-secondary">$449.99</s></small>
                  ...
                  <div className="row py-3">
                    ...
                    <div className="col-md-9 p-0 py-4 py-md-0">
                      <div className="px-4">
                        ...
                        <h5>
                          <small><s className="text-secondary">$219.99</s></small>
            ...
            <div className="slider-client">
              <div className="slider-box text-center">
                ...
                <div className="slider-six">
                  <div>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. In finibus gravida est nec tincidunt. Donec porttitor libero at nisl posuere, eu hendrerit sem fermentum. Nam quis vestibulum ex. Nunc eget auctor enim.
                    </p>
              ...
              <div className="row text-center py-3 bg-primary-color m-0">
                <div className="col-md-4 col-sm-12 my-md-0 my-4">
                  <div className="row justify-content-center text-light">
                    ...
                    <FontAwesomeIcon
                      className="fas fa-rocket fa-4x px-4"
                      icon={faRocket}
                    />
                ...
                <div className="col-md-4 col-sm-12 my-md-0 my-4">
                  <div className="row justify-content-center text-light">
                    ...
                    <FontAwesomeIcon
                      className="fas fa-hand-holding-usd fa-4x px-4"
                ...
                <div className="col-md-4 col-sm-12 my-md-0 my-4">
                  <div className="row justify-content-center text-light">
                    ...
                    <FontAwesomeIcon
                      className="fas fa-headphones-alt fa-4x px-4"
